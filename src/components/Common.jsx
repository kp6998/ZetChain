...
export function NavBar() {
    ...
    const [activeLink, setActiveLink] = useState(pathname === '/' ? '/home' : pathname);
                ...
                <nav className="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav mr-auto">
                            ...
                            <Link
                                to="/team"
                                className={`nav-item nav-link ${activeLink === '/team' ? 'active' : ''}`}
            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">Tharkuri Tech</a>, All Right Reserved.</p>
                    </div>
                    <div className="col-md-6">
                        <p>Designed By <a href="https://Tharkuri.com" target="blank">Tharkuri Tech</a></p>
                    </div>
                </div>
            </div>
        </div>
